...
/**
 * Created by Zhao Qing on 2018/6/21.
 * simpleInputAndOutput.Kafka010ToKafka08
 */
public class Kafka010ToKafka08 {
...
//        kafkaOut010.setFlushOnCheckpoint(true);
        ...
        FlinkKafkaProducer08<String> kafkaOut08 = new FlinkKafkaProducer08<String>("system.imgV2", new SimpleStringSchema(), produce_prop, new StringPartitioner<>());



        DataStream<String> img_copy_to_self = senv.addSource(kafkaIn010);
//        img_copy_to_self.addSink(kafkaOut010);
        img_copy_to_self.addSink(kafkaOut08);
